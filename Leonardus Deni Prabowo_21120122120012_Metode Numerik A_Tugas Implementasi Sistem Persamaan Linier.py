#Leonardus Deni Prabowo_21120122120012_Metode Numerik A_Tugas Implementasi Sistem Persamaan Linier
...
def input_matrix(size):
    matrix = []
    for i in range(size):
        row = list(map(float, input(f"Masukkan Baris Ke-{i+1} (pisahin Spasi): ").split()))
        matrix.append(row)
    return matrix
...
def main():
    ...
    print("1. Pakek Metode Matriks Balikan Aja")
    print("2. Pakek Metode Dekomposisi LU Gauss Aja Udah")
    print("3. Pakek Metode Dekomposisi Crout Paling Bener")
